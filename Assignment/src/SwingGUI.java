...
public class SwingGUI extends JFrame {
	...
	public SwingGUI(String title, int width, int height) {
		...
		left.setBorder(BorderFactory.createEmptyBorder(5,20,50,20));
		p.add(left);
		...
		right.setBorder(BorderFactory.createEmptyBorder(5,20,85,20));
		p.add(right);
	...
	public static void main(String[] args) {
		new SwingGUI("Cotainer & Component",400, 250);
	}
